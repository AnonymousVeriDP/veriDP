...
#include <wmmintrin.h>
#include "my_hhash.h"
#include "config_pc.hpp"  // Use generic F type
...
// Generic field element hashing - works with both 61-bit and 256-bit fields
__hhash_digest hash_single_field_element(const F& x);

__hhash_digest hash_double_field_element_merkle_damgard(const F& x, const F& y, const F& z, const F& w, __hhash_digest prev_hash);
